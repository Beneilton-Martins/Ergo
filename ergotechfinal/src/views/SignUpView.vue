            ...
            <div class="column is-4 is-offset-4">
                ...
                <form @submit.prevent="submitForm">
                    ...
                    <div class="field">
                        <label>Senha</label>
                        <div class="control">
                            <input type="password" placeholder="Digite a senha" name="password1" class="input" v-model="password1">
                        </div>
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input type="password" placeholder="Repita a senha" name="password2" class="input" v-model="password2">
                        </div>
                    </div>
