            ...
            <div class="column is-4 is-offset-4">
                ...
                <form @submit.prevent="submitForm">
                    ...
                    <div class="field">
                        <label>Empresa</label>
                        <div class="control">
                            <input type="text" placeholder="Digite a empresa" name="empresa" class="input" v-model="empresa">
                        </div>
                    </div>
                    ...
                    <label>Senha</label>
                        <div class="field">
                            <div class="control is-expanded">
                                <input type="password" placeholder="Digite sua senha" name="password" class="input" v-model="password">
                            </div>
                        </div>
